    ...
    render() {
        return (
            ...
            <div className="flex justify-center mb-3 mt-4">
                ...
                <div className="text-gray-400 ml-2 w-22 text-center">BEHIND THE MUGS, LIFESTYLE STORIES</div>
                <div className="w-8 h-px bg-gray-400 mt-3 ml-2"></div>
            </div>
            <div className="flex flex-col md:flex-row ">

                <div className="px-3 w-23 order-1 my-6">
                ...
                <div className="px-2 order-2 my-6">
                    <div className="relative">
                        <img className="hover:opacity-75 transition duration-300 h-auto w-auto"
                            src="https://noithattruongsa.com/wp-content/uploads/2020/06/trang-tri-quan-cafe-dep-45.jpg"
                            alt="" />
                ...
                <div className="px-2 order-3 my-6">
                    <div className="relative">
                        <img className="hover:opacity-75 transition duration-300 h-auto w-auto"
                            src="https://noithattruongsa.com/wp-content/uploads/2020/06/trang-tri-quan-cafe-dep-45.jpg"
                            alt="" />
